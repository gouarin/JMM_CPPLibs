...
#ifndef PyBind11IO_hxx
#define PyBind11IO_hxx

void PyBind11IO::PySetArray(KeyCRef key, ndarray arr) {
...
auto PyBind11IO::PyGetArray(KeyCRef key) const -> ndarray {
...
std::string PyBind11IO::GetComputedKeys() const {
